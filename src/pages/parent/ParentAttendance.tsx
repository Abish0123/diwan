...
export default function ParentAttendance() {
  ...
  const schoolDays = days.filter(d => d.status !== "none" && d.status !== "holiday");
          ...
          <div className="bg-white rounded-2xl border border-slate-200 p-5">
            <div className="flex items-center justify-between mb-4">
              ...
              <div className="flex gap-4 text-xs">
                {[["bg-emerald-100 text-emerald-700","Present"],["bg-rose-100 text-rose-700","Absent"],["bg-amber-100 text-amber-700","Late"],["bg-slate-100 text-slate-400","Holiday"]].map(([cls,lbl])=>(
